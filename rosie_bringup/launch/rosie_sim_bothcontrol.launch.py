...
def launch_setup(context, *args, **kwargs):
    ...
    left_robot_traj_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["left_joint_trajectory_controller", "--inactive", "-c", "/controller_manager"],
    )
    
    right_robot_traj_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["right_joint_trajectory_controller", "--inactive", "-c", "/controller_manager"],
    )

    both_arms_controller = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["both_arms_joint_trajectory_controller", "-c", "/controller_manager"],
    )
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "sim_ignition",
            default_value="true",
            description="Use Gazebo Sim for simulation",
        )
    )
    declared_arguments.append(
        DeclareLaunchArgument(
